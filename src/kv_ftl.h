...
#define is_kv_cmd(opcode)                                                                                             \
	(is_kv_append_cmd(opcode) || is_kv_store_cmd(opcode) || is_kv_retrieve_cmd(opcode) || is_kv_delete_cmd(opcode) || \
	 is_kv_iter_req_cmd(opcode) || is_kv_iter_read_cmd(opcode) || is_kv_exist_cmd(opcode)) ||                         \
